...
class ChatBot {
    ...
    initializeResponses() {
        ...
        return {
            ...
            resposta_contato: `📞 <strong>Entre em contato conosco:</strong><br>
                Telefone: (45) 3333-4444<br>
                WhatsApp: (45) 99999-8888<br>
                Email: ogigante@clash.com<br><br>
    ...
    addMessage(message, sender, isHTML = false) {
        ...
        const avatar = sender === 'user' ? 'U' : '<img src="Imagens/GiganteReal.jpg" alt="Bot">';
    ...
    redirectToWhatsApp() {
        ...
        const phoneNumber = '5545999998888'; // Formato: código país + DDD + número
